...
1. Follow the **[fresh-machine setup guide](docs/setup.md)**. Download
   `recorder-0.49.0.zip` from this PR's test release, rather than GitHub's source
...
published there, choose **UCP-Recorder 0.49.0** through the store; the store build
