...
1. Follow the **[fresh-machine setup guide](docs/setup.md)**. Download
   `recorder-0.51.0.zip` from this PR's test release, rather than GitHub's source
...
The 0.51.0 preview adds [clickable seeking](docs/replay-seeking.md), compressed
...
published there, choose **UCP-Recorder 0.51.0** through the store; the store build
