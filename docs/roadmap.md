...
| Seeking | Native progress-bar input, yearly local cache and 25-year embedded SP/MP points, shared native compression, recovery bookmarks | Continuous versus restored playback comparison and native capture/restore latency; see [seeking gates](replay-seeking.md) |
...
Launcher translations cover all nine languages; in-game catalogs cover English,
German, French, Russian, Hungarian, Turkish, Chinese, Spanish, Persian, Italian
and Polish. Font coverage and clipping still need installation-specific checks.
Ghidra confirms that the supported executable's wide-text
