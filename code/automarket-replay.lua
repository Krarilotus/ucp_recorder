...
function M.current()
  ...
  -- Automarket owns the 272-byte payload; verify transport/save capabilities
  -- through their existing owners rather than a stale package-version list.
  require('code/native-command').bind({})
