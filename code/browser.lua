...
-- Playback selection/readiness only. Native battle history owns rows, scrolling,
-- repeat-click statistics and naming; the retired standalone menu has no model.
local Browser={}
